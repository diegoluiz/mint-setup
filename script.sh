...
sudo apt install -y synapse zsh git vim python-pip python3-pip vagrant docker.io golang r-base libjpeg62 redis-tools mpg123 nmap libxml2-utils ruby ruby-dev make gcc dict devhelp htop tor
